              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border-radius:16px;margin-bottom:25px;overflow:hidden;">
                <tr>
                  <td style="padding:20px 25px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ${booking.family2 ? `<tr><td style="padding:8px 0;border-bottom:1px solid #252525;"><span style="color:#aaaaaa;font-size:13px;">+2 Familiares</span><span style="color:#ffffff;font-size:13px;float:right;">$50</span></td></tr>` : ''}
                      ${booking.family4 ? `<tr><td style="padding:8px 0;border-bottom:1px solid #252525;"><span style="color:#aaaaaa;font-size:13px;">+4 Familiares</span><span style="color:#ffffff;font-size:13px;float:right;">$80</span></td></tr>` : ''}
                      ${booking.hairMakeup ? `<tr><td style="padding:8px 0;"><span style="color:#aaaaaa;font-size:13px;">Peluqueria y Maquillaje</span><span style="color:#ffffff;font-size:13px;float:right;">$90</span></td></tr>` : ''}
                      ${booking.additionalServicesCost ? `<tr><td style="padding-top:12px;border-top:1px solid #333333;"><span style="color:#c9a962;font-size:13px;font-weight:600;">Total Servicios</span><span style="color:#c9a962;font-size:13px;font-weight:600;float:right;">$${booking.additionalServicesCost}.00</span></td></tr>` : ''}
                    </table>
                  </td>
                </tr>
              </table>
